...
var AppComponent = require('../../../../../../../src/app/services/master.service');
...
},
{
  ...
  lazyLoad: true,
  weight: 10,
  tooltip: 'The screen name to be used with this field.',
  conditional: {
    json: {
      '===': [{
        var: 'data.dataSrc'
...
},
{
  ...
  dataSrc: 'url',
  data: {
    /* url: AppComponent.MasterService.prototype.getMahesh(), */
  },
  authenticate: true,
  template: '<span>{{ item.data.name }}</span>',
  valueProperty: 'data',
  ...
  lazyLoad: true,
  weight: 10,
  tooltip: 'The master name to be used with this field.',
  conditional: {
    json: {
      '===': [{
        var: 'data.dataSrc'
  ...
  data: {
    url: '/api/eimaster/master/{{ data.data.resource }}'
  },
  conditional: {
    json: {
      and: [{
...
},
{
  ...
  key: 'quryValmaster',
  weight: 8,
  label: 'Master Query Parameter',
  placeholder: 'Master Query Parameter',
  tooltip: 'Query parmater for master.',
  conditional: {
    json: {
      '===': [{
        var: 'data.dataSrc'
...
},
{
  ...
  key: 'quryValscreen',
  weight: 8,
  label: 'Screen Query Parameter',
  placeholder: 'Screen Query Parameter',
  tooltip: 'Query parmater for screen.',
  conditional: {
    json: {
      '===': [{
        var: 'data.dataSrc'
...
},
{
  ...
  conditional: {
    json: {
      in: [{
        var: 'data.dataSrc'
      }, ['url', 'resource', 'values', 'master', 'screen']]
    }
  }
}, {
  type: 'checkbox',
