...
@Component({
  selector: 'app-all-upload',
  templateUrl: './all-upload.component.html',
  styleUrls: ['./all-upload.component.scss']
})
export class AllUploadComponent implements OnInit {
  ...
  columnDefs = [
    ...
    { field: 'screenName', headerName: 'Screen Name', sortable: true, filter: 'agTextColumnFilter', floatingFilter: true },
